...
import com.yantailor.turing_web_re.bean.ResponseBean;
...
public class TransferUtil {
    ...
    public ResponseBean TransferFile(MultipartFile multipartFile , String sourceDir){
        int readLen = 0;
     ...
     * @param:  sourceDir 文件存放位置
     */
    public ResponseBean TransferFiles(MultipartFile[] multipartFile , String sourceDir){
        try {
